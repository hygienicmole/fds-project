...
def visualize_comprehensive_comparison(
    ...
    if save_path:
        ...
        print(f"[OK] Comprehensive comparison saved to: {save_path}")
...
def visualize_perturbation_heatmaps(
    ...
    if save_path:
        plt.savefig(save_path, dpi=300, bbox_inches='tight')
        print(f"[OK] Perturbation heatmaps saved to: {save_path}")
...
def plot_class_wise_attack_success(
    ...
    if save_path:
        plt.savefig(save_path, dpi=300, bbox_inches='tight')
        print(f"[OK] Class-wise attack success rates saved to: {save_path}")
...
def plot_confidence_distributions(
    ...
    if save_path:
        plt.savefig(save_path, dpi=300, bbox_inches='tight')
        print(f"[OK] Confidence distributions saved to: {save_path}")
