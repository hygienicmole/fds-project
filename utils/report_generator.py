...
class ReportGenerator:
    ...
    def load_all_results(self):
        ...
        if os.path.exists(attack_path):
            ...
            print(f"  ✓ Loaded attack evaluation results")
        else:
            print(f"  ⚠ Attack evaluation results not found")
        ...
        if os.path.exists(hyperparam_path):
            ...
            print(f"  ✓ Loaded hyperparameter analysis results")
        else:
            print(f"  ⚠ Hyperparameter analysis results not found")
        ...
        if os.path.exists(baseline_path):
            ...
            print(f"  ✓ Loaded baseline training metrics")
        else:
            print(f"  ⚠ Baseline training metrics not found")
