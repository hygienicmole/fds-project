...
def demo_untargeted_pgd(model, test_loader, device, epsilon=8/255, alpha=2/255, iterations=20):
    ...
    print("\n✓ Untargeted PGD attack demonstration complete!")
...
def demo_targeted_pgd(model, test_loader, device, epsilon=8/255, alpha=2/255, iterations=20):
    ...
    print("\n✓ Targeted PGD attack demonstration complete!")
...
def demo_pgd_vs_fgsm(model, test_loader, device, epsilon=8/255):
    ...
    print("\n✓ PGD vs FGSM comparison complete!")
...
def demo_random_start_effect(model, test_loader, device, epsilon=8/255, iterations=20):
    ...
    print("\n✓ Random initialization demonstration complete!")
...
def demo_alpha_tuning(model, test_loader, device, epsilon=8/255, iterations=20):
    ...
    print("\n✓ Alpha tuning demonstration complete!")
...
def main():
    ...
    try:
        ...
        print("Key Takeaways:")
        print("  ✓ PGD is significantly stronger than FGSM")
        print("  ✓ Iterative refinement finds better adversarial examples")
        print("  ✓ Random initialization helps escape local minima")
        print("  ✓ Projection ensures L∞ constraint satisfaction")
        print("  ✓ 20-40 iterations typically sufficient")
        print("  ✓ Alpha ≈ ε/4 is a good default choice")
        print()
