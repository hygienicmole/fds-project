...
def demo_untargeted_attack(model, test_loader, device, epsilon=8/255):
    ...
    print("\n[OK] Untargeted attack demonstration complete!")
...
def demo_targeted_attack(model, test_loader, device, epsilon=8/255):
    ...
    print("\n[OK] Targeted attack demonstration complete!")
...
def demo_epsilon_comparison(model, test_loader, device):
    ...
    print()
    print("[OK] Epsilon comparison complete!")
...
def demo_batch_processing(model, test_loader, device, epsilon=8/255):
    ...
    print(f"[OK] Generated {len(x_adv)} adversarial examples")
    ...
    print("\n[OK] Batch processing demonstration complete!")
...
def main():
    ...
    try:
        ...
        print()
        print("Key Takeaways:")
        print("  [OK] FGSM is a simple yet effective one-step attack")
        print("  [OK] Works for both untargeted and targeted scenarios")
        print("  [OK] Trade-off between attack success and perturbation visibility")
        print("  [OK] L∞ norm constraint ensures bounded perturbations")
        print("  [OK] Demonstrates vulnerability of standard-trained models")
        print()
        print("Next Steps:")
