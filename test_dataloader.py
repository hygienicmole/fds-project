...
def test_statistics_loading():
    ...
    print("[OK] Statistics loading test passed!")
    return stats
...
def test_dataloader_creation():
    ...
    print("[OK] Dataloader creation test passed!")
...
def test_batch_loading(train_loader, test_loader):
    ...
    print("[OK] Batch loading test passed!")
...
def test_visualization(train_loader):
    ...
    print("[OK] Sample visualization test passed!")
...
def test_augmentation_visualization():
    ...
    print("[OK] Augmentation visualization test passed!")
...
def test_class_distribution(test_loader):
    ...
    print("[OK] Class distribution test passed!")
...
def test_dataset_info(train_loader, test_loader):
    ...
    print("[OK] Dataset info test passed!")
