...
def visualize_fgsm_attack(
    ...
    for i in range(num_samples):
        ...
        if targeted and target_labels is not None:
            ...
            success = '[OK]' if preds_adv[i] == target_labels[i] else '[X]'
            axes[i, 1].set_title(
            ...
            success = '[OK]' if preds_adv[i] != labels[i] else '[X]'
            axes[i, 1].set_title(
                f'Adversarial {success}\nPred: {pred_adv_class}',
                fontsize=10,
                color=color
...
if __name__ == '__main__':
    ...
    print()
    print("Key Features:")
    print("  [OK] Untargeted attacks (cause any misclassification)")
    print("  [OK] Targeted attacks (force specific misclassification)")
    print("  [OK] Perturbation analysis (L0, L1, L2, L∞ norms)")
    print("  [OK] Attack success evaluation")
    print("  [OK] Visualization utilities")
    print("  [OK] Comprehensive mathematical documentation")
    print()
    print("Usage Example:")
    print()
