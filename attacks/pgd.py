...
if __name__ == '__main__':
    ...
    print()
    print("Key Features:")
    print("  ✓ Iterative attack (stronger than FGSM)")
    print("  ✓ Untargeted and targeted attacks")
    print("  ✓ Random initialization")
    print("  ✓ L∞ norm constraint with projection")
    print("  ✓ Attack progression tracking")
    print("  ✓ Perturbation analysis")
    print("  ✓ Visualization of attack evolution")
    print()
    print("Usage Example:")
    print()
